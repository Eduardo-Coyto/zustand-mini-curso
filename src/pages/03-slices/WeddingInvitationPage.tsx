...
export const WeddingInvitationPage = () => {
  ...
  const setEventDay = useWeddingBoundStore(state => state.setEventDate);
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                value={ guestCount }
                onChange={ (e) => setGuestCount( +e.target.value )} // Se agrega "+" al iniciio de e.target.value porque por default es un strig pero con "+" lo transforme a number
              />
            </div>
